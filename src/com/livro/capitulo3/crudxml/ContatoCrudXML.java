...
public class ContatoCrudXML {
	...
	public void salvar(Contato contato) {
		...
		try {
			...
			try { 
				...
				System.out.println("Falha ao fechar operação de inserção.\nErro: " + e.getMessage());
			}
		}
	}
	...
	public void atualizar(Contato contato) {
		...
		try {
			...
			try {
				...
				System.out.println("Falha ao fechar operação de alteração.\nErro: " + e.getMessage());
			}
		}
	}
	...
	public static void main(String[] args) {
		...
		String[] emails ={"emerson@teste.com","rodrigo@teste.com","orci@teste.com"};
		...
		System.out.println("Total de registros na tabela de Contatos " + contatoCrudXML.listar().size());
	}
